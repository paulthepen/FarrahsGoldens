<form action="submit.php" type="POST">
    ...
    <div class="row required" style='margin-top: 20px;'>
        ...
        <span class="col-md-2 align-middle">
        ...
        <div class="col-md-2">
            <input class='form-check-input' type='radio' name='gender' id='input-gender' value='either'>
            <label for="input-gender" class="form-check-label">
                No preference
            </label>
        </div>
    ...
    <div class="row required" style='margin-top: 20px;'>
        <div class="col-md-4 offset-sm-2">
            <label>Do you plan on picking up your puppy in Sweetwater, TN?</label>
        </div>
        <span class="col-md-2 align-middle">
            <input class='form-check-input' type='radio' name='transport' id='input-transport' value='yes'>
            <label for="input-transport" class="form-check-label">
                Yes
            </label>
        </span>
        <div class="col-md-2">
            <input class='form-check-input' type='radio' name='transport' id='input-transport' value='no'>
            <label for="input-transport" class="form-check-label">
                No
            </label>
        </div>
    ...
    <div class="row required">
        ...
        <div class="col-md-6" id='family-list'>
    ...
    <div class="row required">
        ...
        <div class="col-md-6" id='pet-list'>
            <div class="input-group">
